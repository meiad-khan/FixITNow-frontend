        ...
        <div className="mx-auto max-w-2xl">
          <div className="rounded-2xl border bg-background p-8 text-center shadow-sm md:p-10">
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-amber-100">
              <CircleX className="h-10 w-10 text-amber-600" />
            </div>
            ...
            <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-muted-foreground md:text-base">
              Your payment was not completed. No payment has been charged for
              this transaction.
            </p>
        ...
        <div className="mx-auto max-w-2xl">
          <div className="rounded-2xl border bg-background p-8 text-center shadow-sm md:p-10">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-muted-foreground">
              We could not retrieve the payment details, but your payment was not
              completed.
            </p>
    ...
    <main className="min-h-[calc(100vh-4rem)] bg-muted/30 px-4 py-10 md:py-14">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="text-center">
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-amber-100">
            <CircleX className="h-11 w-11 text-amber-600" />
          </div>
          ...
          <p className="mx-auto mt-3 max-w-lg text-sm leading-6 text-muted-foreground md:text-base">
            Your payment was not completed. No payment has been charged for this
            transaction.
          </p>
        </section>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Information about the cancelled payment
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-5 flex items-start gap-3 rounded-xl border bg-background p-4">
          ...
          <div>
            <p className="text-sm font-medium">
              Your booking is still available
            </p>

            <p className="mt-1 text-xs leading-5 text-muted-foreground">
              Cancelling the payment does not mean your service booking has been
              cancelled. You can return to your booking and complete the payment
        ...
        <p className="mt-5 text-center text-xs text-muted-foreground">
          You can complete your payment later from your booking details.
        </p>
      </div>
    </main>
  )
